function show(enabled, useSettingsInsteadOfPreferences) {
  if (useSettingsInsteadOfPreferences) {
    document.getElementsByClassName("state-on")[0].innerText =
      "TabCap’s extension is currently on. You can turn it off in the Extensions section of Safari Settings.";
    document.getElementsByClassName("state-off")[0].innerText =
      "TabCap’s extension is currently off. You can turn it on in the Extensions section of Safari Settings.";
    document.getElementsByClassName("state-unknown")[0].innerText =
      "You can turn on TabCap’s extension in the Extensions section of Safari Settings.";
